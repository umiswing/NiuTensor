...
if [ "$HARDWARE" == "GPU" ]; then
    ./bin/NiuTensor -dev 6 -fp16 1 -model ./model/model.fp16 -srcvocab ./model/vocab.txt -tgtvocab ./model/vocab.txt -sbatch 3072 -wbatch 64000 < nts.tmp.bpe | parallel --pipe -L 4000 --keep-order "perl ./nts-scripts/detokenizer.perl -q -l de"
else
